...
/**
 * Projects a hotspot's (yaw, pitch) — the SAME values already trusted for
 * navigation, from the validated catalog — onto the current viewport, given
 * the tour's live camera orientation (see tour-bridge's getCameraState).
 *
